...
class MissingFromRepoPackageSelection(
    ...
    def augment_config(self, config_path, args):  # noqa: D102
        ...
        # TODO(cottsay): Stop using module-level logging in ros_buildfarm
        logging.root.setLevel(_get_effective_log_level())

        index_url = (config_path / 'index.yaml').resolve().as_uri()
